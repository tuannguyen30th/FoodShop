 ...
 * @author Tuan
 */
@WebServlet(name = "numberSizeStatus", urlPatterns = {"/numberSizeStatus"})
public class numberSizeStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession(true);
             ...
             request.getRequestDispatcher("statusUser.jsp").forward(request, response);
    }
