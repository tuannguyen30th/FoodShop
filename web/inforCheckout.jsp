                    ...
                    <div class="form-container">
                        <form action="checkout" method="post">
                          <p>Fill in your information before delivery</p>
                           <h3>Instructions for filling in information to place an order:</h3>
                          <ul>
                            <li>With the address, you need to enter clearly and fully information including: district - ward - house number</li>
                            <li>With phone number, please enter the correct phone number</li>   
                            <li>Please read the information before filling in the information form, thank you!</li>                       
                          </ul>
